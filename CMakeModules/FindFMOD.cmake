...
IF (WIN32) #Windows
    MESSAGE(STATUS "Looking for FMOD in path ${FMOD_INCLUDE_SEARCH_DIRS}")
	FIND_PATH(FMOD_INCLUDE_DIRS fmod.h ${FMOD_INCLUDE_SEARCH_DIRS})
	FIND_PATH(FMOD_LIBRARY_DIRS fmod.dll ${FMOD_LIBRARY_SEARCH_DIRS})
	FIND_LIBRARY(FMOD_LIBRARIES debug fmodL64_vc optimized fmod64_vc PATHS ${FMOD_LIBRARY_SEARCH_DIRS})
